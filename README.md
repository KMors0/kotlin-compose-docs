...
1. Прочитайте [Введение](00-introduction.md), чтобы понять, почему этот стек актуален.
2. Начните с раздела [Основы Kotlin](01-kotlin-basics.md), если вы новичок в языке.
3. Перейдите к [Compose Multiplatform](02-compose-multiplatform.md) для изучения UI-фреймворка.
4. Изучите [Material Design 3](03-material-design-3.md) для создания красивых интерфейсов.
5. Соберите первое приложение по [Практическому примеру](04-practical-example.md).
6. Для глубокого понимания — изучите разделы 20–27.
